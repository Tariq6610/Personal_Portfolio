...
function Home() {
  return (
    <div className=" flex relative w-screen justify-center items-center md:mt-40 flex-wrap gap-x-24 gap-y-9 ">
      <div className="w-96 px-4 md:p-0 order-2 sm:order-1 relative">
        <h1 className={`${styles.profile}  w-fit mb-8 mt-4`}>M Tariq</h1>
        <p className={`${styles.para} relative md:left-[3rem] w-fit text-xl`}>
